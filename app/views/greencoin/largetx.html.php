...
<h3><?=$t('How it works?')?></h3>
  ...
  <div class="panel-body">
    <img src="/img/OSX/Help - Debug - Information - identification.log.jpg" width="800">
		...
		<div class="panel-footer"><?=$t('Identification log file is important. This shows your log file which is added to GreenCoinX')?> <u><?=$t('blockchain')?></u>. <?=$t('The ##CODE##: can you used to')?> '<a href='/greencoin/identification'><?=$t('identification')?></a>' <?=$t('of a person through email / phone search.')?>
		</div>
	</div>		
