...
<div class="row">
<div class="col-md-12"><h4><?=$t('The Technical Wallet is only for users who wish to carry out Mining functions and for certain retailers. All other users should use GreenCoinX by opening an online wallet at')?> <a style="color:white" href="https://xgcwallet.org" target="_blank">www.xgcwallet.org</a></h4></div>
	<div class="col-md-2"> 
<h3><?=$t('How it works?')?></h3>
  ...
  <div class="panel-body">
    <img src="/img/GC-001.jpg">
		...
		<div class="panel-footer"><?=$t('First time sync. You will have to setup identification to use GreenCoinX. Click on Settings -> Options -> Identification tab and verify your email and phone.')?>
		</div>
	</div>
  ...
  <div class="panel-body">
    <img src="/img/GC-003.jpg">
  </div>
		<div class="panel-footer"><?=$t('Click on Start Verification to verify your email and phone.')?>
		</div>
	</div>	
  ...
  <div class="panel-body">
	...
	<a href="#7" class="btn btn-circle page-scroll" style="color:white">
		...
		<div class="panel panel-success">
  <div class="panel-heading">
    <a name="9"></a><h3 class="panel-title"><?=$t('Get Code')?></h3>
  </div>
  <div class="panel-body">
    <img src="/img/GC-010.jpg">
  </div>
		<div class="panel-footer"><?=$t('Click \'Yes\'. You will receive SMS on your mobile phone.')?>
		</div>
	</div>		
	...
	<a href="#8" class="btn btn-circle page-scroll" style="color:white">
		...
		<div class="panel panel-success">
  <div class="panel-heading">
    <a name="10"></a><h3 class="panel-title"><?=$t('Enter phone verify code')?></h3>
  </div>
  <div class="panel-body">
    <img src="/img/GC-011.jpg">
  </div>
		<div class="panel-footer"><?=$t('Click \'Verify\'. This will verify your phone number.')?>
		</div>
	</div>		
	...
	<a href="#9" class="btn btn-circle page-scroll" style="color:white">
		...
		<div class="panel panel-success">
  <div class="panel-heading">
    <a name="11"></a><h3 class="panel-title"><?=$t('Verify phone code')?></h3>
  </div>
  <div class="panel-body">
    <img src="/img/GC-012.jpg">
  </div>
		<div class="panel-footer"><?=$t('Click \'Yes\'. To complete verification of phone.')?>
		</div>
	</div>		

	<div style="text-align:center">
	<a href="#12" class="btn btn-circle page-scroll" style="color:white">
		<i class="fa fa-angle-double-down animated fa-3x"></i>
	</a>
	<a href="#10" class="btn btn-circle page-scroll" style="color:white">
		<i class="fa fa-angle-double-up animated fa-3x"></i>
		...
		<div class="panel panel-success">
  <div class="panel-heading">
    <a name="12"></a><h3 class="panel-title"><?=$t('Additional Info')?></h3>
  </div>
  <div class="panel-body">
    <img src="/img/GC-013.jpg">
  </div>
	...
	<div style="text-align:center">
	<a href="#13" class="btn btn-circle page-scroll" style="color:white">
		<i class="fa fa-angle-double-down animated fa-3x"></i>
	</a>
	<a href="#11" class="btn btn-circle page-scroll" style="color:white">
		<i class="fa fa-angle-double-up animated fa-3x"></i>
		...
		<div class="panel panel-success">
  <div class="panel-heading">
    <a name="13"></a><h3 class="panel-title"><?=$t('Confirm Verification')?></h3>
  </div>
  <div class="panel-body">
    <img src="/img/GC-014.jpg">
  </div>
	...
	<div style="text-align:center">
	<a href="#14" class="btn btn-circle page-scroll" style="color:white">
		<i class="fa fa-angle-double-down animated fa-3x"></i>
	</a>
	<a href="#12" class="btn btn-circle page-scroll" style="color:white">
		<i class="fa fa-angle-double-up animated fa-3x"></i>
		...
		<div class="panel panel-success">
  <div class="panel-heading">
    <a name="14"></a><h3 class="panel-title"><?=$t('Check Identification log')?></h3>
  </div>
  <div class="panel-body">
    <img src="/img/GC-015.jpg">
  </div>
		<div class="panel-footer"><?=$t('Click on Help -> Debug. You will be able to open Identification log file.')?>
		</div>
	</div>		

	<div style="text-align:center">
	<a href="#15" class="btn btn-circle page-scroll" style="color:white">
		<i class="fa fa-angle-double-down animated fa-3x"></i>
	</a>
	<a href="#13" class="btn btn-circle page-scroll" style="color:white">
		<i class="fa fa-angle-double-up animated fa-3x"></i>
		...
		<div class="panel panel-success">
  <div class="panel-heading">
    <a name="15"></a><h3 class="panel-title"><?=$t('Identification log')?></h3>
  </div>
  <div class="panel-body">
    <img src="/img/GC-016.jpg">
  </div>
